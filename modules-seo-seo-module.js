...
var SeoService = /** @class */ (function () {
    ...
    SeoService.prototype.create = function (item) {
        return;
    };
    SeoService.prototype.update = function (item) {
        return;
    };
...
var CreateSeoComponent = /** @class */ (function () {
    ...
    CreateSeoComponent.prototype.onSubmit = function () {
        ...
        console.log(this.createSeoForm.value);
...
var EditSeoComponent = /** @class */ (function () {
    ...
    EditSeoComponent.prototype.onSubmit = function () {
        ...
        console.log(this.editSeoForm.value);
        // this.seoService.create(this.createSeoForm.value).subscribe(
        //         data => {
        //             this.toastr.success(this.translate.instant('items.messages.create'), this.translate.instant('items.title'));
        //             this.event.emit({data: true});
...
/* harmony import */ var _components_create_seo_create_seo_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../components/create-seo/create-seo.component */ "./src/app/modules/seo/components/create-seo/create-seo.component.ts");
...
var SeoListComponent = /** @class */ (function () {
    function SeoListComponent(translate, ngxRolesService, http, toastr, modalService, exportAsService, authenticationService) {
        var _this = this;
        this.translate = translate;
    ...
    SeoListComponent.prototype.openSeoCreateModal = function () {
        this.modalRef = this.modalService.show(_components_create_seo_create_seo_component__WEBPACK_IMPORTED_MODULE_12__["CreateSeoComponent"], this.modalConfigs);
        // debugger
