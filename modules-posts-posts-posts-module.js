...
var PostCreateComponent = /** @class */ (function () {
    function PostCreateComponent(translate, datepipe, router, formBuilder, toastr, categorysService, postsService, clientService, itemService, optionsService, taxService, 
    ...
    PostCreateComponent.prototype.loadForm = function () {
        ...
        this.createPostForm = this.formBuilder.group({
            ...
            properties: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
    ...
    PostCreateComponent.prototype.getVariations = function (data) {
        var variationsData = {
            ...
            // compare_price: ['', [Validators.required, Validators.min(1)]],
            check: [true]
        };
    ...
    PostCreateComponent.prototype.loadDropzone = function (elementDropzone) {
        ...
        var myDropzone = new dropzone__WEBPACK_IMPORTED_MODULE_15__(this[elementDropzone].nativeElement, {
...
var PostEditComponent = /** @class */ (function () {
    function PostEditComponent(translate, datepipe, router, route, formBuilder, toastr, postService, clientService, optionsService, categorysService, itemService, taxService, authenticationService) {
        var _this_1 = this;
        this.translate = translate;
        this.datepipe = datepipe;
        this.router = router;
    ...
    PostEditComponent.prototype.loadForm = function () {
        ...
        this.editPostForm = this.formBuilder.group({
            ...
            category: [this.post.po_cates_id],
            ...
            properties: [this.post.properties, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            variations: this.formBuilder.array([]),
            specifications: this.formBuilder.array([])
        });
        if (this.moduletype == 'products') {
    ...
    PostEditComponent.prototype.loadDropzone = function (elementDropzone) {
        ...
        var limitFile;
        elementDropzone == 'avatardropzone' ? limitFile = 1 : limitFile = 100;
        new dropzone__WEBPACK_IMPORTED_MODULE_15__(this[elementDropzone].nativeElement, {
            url: 'https://httpbin.org/post',
            maxFiles: limitFile,
            clickable: true,
            acceptedFiles: 'image/*',
    ...
    PostEditComponent.prototype.getSpecifications = function (data, value) {
        var valueSpecifications = value.options_value_indentify ? value.options_value_indentify : null;
        return this.formBuilder.group({
            name: [data.name, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
