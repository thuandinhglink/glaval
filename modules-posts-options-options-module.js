...
var OptionsEditComponent = /** @class */ (function () {
    ...
    OptionsEditComponent.prototype.loadForms = function () {
        ...
        for (var _i = 0, _a = this.options.options; _i < _a.length; _i++) {
            ...
            control.push(this.formBuilder.group({
                name: [valueOption.indentify, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
                id: [valueOption.id]
            }));
        }
...
var OptionsListsComponent = /** @class */ (function () {
    ...
    OptionsListsComponent.prototype.deleteSpecification = function (id) {
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_11___default.a.fire({
            ...
            text: this.translate.instant('common.swal.text') + this.translate.instant('options.title'),
            type: 'warning',
            ...
            if (result.value) {
                _this.optionsService.delete(id).subscribe(function (data) {
                    _this.toastr.success(_this.translate.instant('options.messages.delete'), _this.translate.instant('options.title'));
                    _this.rerender();
                });
            }
        });
