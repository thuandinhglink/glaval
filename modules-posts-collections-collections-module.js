...
var CollectionCreateComponent = /** @class */ (function () {
    function CollectionCreateComponent(translate, datepipe, router, formBuilder, toastr, categorysService, collectionsService, clientService, itemService, taxService, 
...
var CollectionEditComponent = /** @class */ (function () {
    function CollectionEditComponent(translate, datepipe, router, route, formBuilder, toastr, collectionService, clientService, itemService, taxService, authenticationService) {
        var _this_1 = this;
        this.translate = translate;
        this.datepipe = datepipe;
        this.router = router;
    ...
    CollectionEditComponent.prototype.loadDropzone = function () {
        ...
        new dropzone__WEBPACK_IMPORTED_MODULE_13__(this.logodropzone.nativeElement, {
            ...
            init: function () {
                this.on('addedfile', function (file) {
                    var _this_1 = this;
                    var removeButton = dropzone__WEBPACK_IMPORTED_MODULE_13__["createElement"]('<button class=\'btn btn-sm btn-block\'>Remove file</button>');
                    var _this = this;
                    removeButton.addEventListener('click', function (e) {
                        e.preventDefault();
                        e.stopPropagation();
