...
var CategoryCreateComponent = /** @class */ (function () {
    function CategoryCreateComponent(translate, datepipe, router, formBuilder, toastr, categorysService, optionsService, clientService, taxService, 
    ...
    CategoryCreateComponent.prototype.loadDropzone = function () {
        var that = this;
        new dropzone__WEBPACK_IMPORTED_MODULE_12__(this.logodropzone.nativeElement, {
...
var CategoryEditComponent = /** @class */ (function () {
    function CategoryEditComponent(translate, datepipe, router, route, formBuilder, toastr, categoryService, optionsService, clientService, itemService, taxService, authenticationService) {
        var _this_1 = this;
        this.translate = translate;
        this.datepipe = datepipe;
        this.router = router;
